...
# 루트 헬스체크 (Cloud Run 확인용)
@app.route("/healthz", methods=["GET"])
def health_check():
    return jsonify({"service": "jangpro-agent", "status": "OK", "timestamp": datetime.now().isoformat()})

# 업비트 + Gemini 분석 메인 엔드포인트
